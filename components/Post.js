...
export default function Post({info,comment,body,creator,created_at,id}) {
...
<Card className="rounded-lg ">
  <CardBody className=''>
    <div className="flex">
      ...
      <div className="ml-2">
        <p className="font-semibold dark:text-gray-300">{creator_name}</p>
    ...
    <div className="flex items-end justify-between">
      <div>
        <Button onClick={HandleShow} size="small" type="neutral">Read more</Button>
      </div>
      <div>

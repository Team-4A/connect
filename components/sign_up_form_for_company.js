...
export default function SignUpFormForCompany() {
 async function event_handler(e){
  ...
  <div className="w-full max-w-md space-y-8">
    ...
    <form onSubmit={event_handler} className="mt-8 space-y-6" action="#" method="POST">
      ...
      <div className="-space-y-px rounded-md shadow-sm">
        ...
        <div>
          ...
          <input id="password" name="phonenumber" type="number" autoComplete="current-password" required className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-none appearance-none rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Phonenumber"/>
        </div>
        
        <div>
          <label htmlFor="CommericalCertificate">CommericalCertificate</label>
          <input accept="image/*" id="CommericalCertificate" name="CommericalCertificate" type="file" autoComplete="current-password" required className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-none appearance-none rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="CommericalCertificate"/>
        </div>
        <div>
          <label htmlFor="ID_Card" >ID Card</label>
          <input id="ID_Card" accept="image/*" name="ID_Card" type="file" autoComplete="ID_Card" required className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-none appearance-none rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="ID Card"/>
        </div>
      </div>

...
export default function CompanyCard({ allOffers, userData, user_id, }) {
                  ...
                  <div id="content" className="content content-full-width">
                     ...
                     <!-- BEGIN profile-header-info --> */}
                              <div className="profile-header-info">
                                 ...
                                 {sliderShow == false ? <button onClick={() => setSliderShow(true)} className="btn btn-primary f-s-12 rounded-corner" type="button">Preview Offers</button>:<button onClick={() => setSliderShow(false)} className="btn btn-primary f-s-12 rounded-corner" type="button">Hide Offers</button>}

                                 
                                 <div className='flex justify-end '>
                                    <button onClick={() => setModalShow(true)} className="btn btn-primary f-s-12 rounded-corner" type="button">Create Post</button>
                                       ...
                                       <Modal.Body>
                                          <Form onSubmit={createNewPost}>
                                             ...
                                             <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                                ...
                                                <Form.Control name="postcontent" as="textarea" rows={3} />
                                             </Form.Group>
                        ...
                        <div className="p-0 tab-content">
                           ...
                           <div className="tab-pane fade active show" id="profile-post">
                              ...
                              <ul className="timeline">
                                 {/* body: "hi i am ahmad"
created_at: "2021-12-14T19:08:09.306070Z"
creator: 3
id: 1
likes: [1] */}
  {sliderShow && allOffers && allOffers.map((item, idx) => {
                                             if (user_id == item.to_company) {
                           ...
                           <!-- begin timeline-icon --> */}
                                                      ...
                                                      <div className="timeline-body">
                                                         <div className="timeline-header">
                                                            <span className="userimage"><img src="https://ict4kids.files.wordpress.com/2013/05/mrc-2.png" alt="" /></span>
                                                            <span className="username">Offers - </span>
                                                         </div>
                           ...
                           <!-- begin timeline-body --> */}
                                             <div className="timeline-body">
                                                <div className="timeline-header">
                                                   ...
                                                   <span className="username"><a href="javascript:;">{userData.username}</a> <small></small></span>
